      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 xl:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-16 mb-16">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
            ...
            <div className="lg:col-span-1 pr-4">
              <Link href="/" className="text-3xl font-black tracking-tight flex items-center mb-4">
                ...
                <span className="text-[#7A0C2E] font-black">Dial</span>
              </Link>
              <div className="w-8 h-1 bg-[#7A0C2E] rounded-full mb-6"></div>
            ...
            <div className="lg:col-span-1 pl-0 md:pl-4 lg:border-l border-slate-200">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-emerald-50 text-[#7A0C2E] flex items-center justify-center shrink-0">
              ...
              <div className="w-6 h-0.5 bg-[#7A0C2E] rounded-full mb-6 ml-[52px]"></div>
              <ul className="space-y-4 text-[13px] text-slate-600 font-semibold ml-[52px]">
                {['Top Categories', 'Featured Businesses', 'How BizDial Works', 'Browse Locations'].map((item, idx) => (
                  <li key={idx}><a href="#" className="flex items-center justify-between hover:text-[#7A0C2E] transition-colors group pr-4">{item} <ChevronRight size={14} className="text-emerald-500 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0" /></a></li>
                ))}
              </ul>
            </div>
            {/* Grow With Us */}
          ...
          <div className="w-full lg:w-[360px] shrink-0 lg:mt-[-40px]">
            <div className="bg-white rounded-3xl p-8 shadow-[0_15px_50px_rgba(0,0,0,0.06)] border border-slate-100 relative overflow-hidden h-full z-20">
              ...
              <div className="w-12 h-12 bg-emerald-50 text-[#7A0C2E] rounded-full flex items-center justify-center mb-6">
              ...
              <button className="w-full bg-[#7A0C2E] hover:bg-emerald-700 text-white font-bold py-3.5 rounded-xl text-sm flex items-center justify-center gap-2 shadow-lg shadow-[#7A0C2E]/30 transition-all hover:scale-[1.02]">
        ...
        <div className="bg-white rounded-[2rem] p-6 lg:p-8 mb-12 shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-slate-100 flex flex-wrap lg:flex-nowrap items-center justify-between gap-6 relative z-20 mx-0 xl:mx-10">
          ...
          <div className="flex items-center gap-4 flex-1 min-w-[200px]">
            <div className="w-14 h-14 rounded-2xl bg-emerald-50 text-[#7A0C2E] flex items-center justify-center shrink-0">
        ...
        <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 relative z-20 mx-0 xl:mx-10">
          ...
          <div className="flex gap-6 text-[12px] text-slate-500 font-medium">
            <a href="#" className="hover:text-[#7A0C2E] transition-colors">Privacy Policy</a>
            <span className="text-slate-300">•</span>
            <a href="#" className="hover:text-[#7A0C2E] transition-colors">Terms of Use</a>
            <span className="text-slate-300">•</span>
            <a href="#" className="hover:text-[#7A0C2E] transition-colors">Sitemap</a>
          </div>
