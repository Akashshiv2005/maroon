      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-6 sm:mb-10 gap-4 relative z-10">
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-[42px] font-black text-slate-900 mb-1 tracking-tight">
            Featured Businesses <span className="text-[#7A0C2E]">in {userLocation}</span>
          </h2>
        </div>
      ...
      <div className="relative z-10">
        ...
        >
          {(showAllFeatured ? featuredBusinesses : featuredBusinesses.slice(0, 5)).map((bus, i) => {
            const themes = [
              { cardBg: 'bg-gradient-to-b from-[#e6f4ea] from-[40%] to-white to-[80%]', badge: 'bg-[#7A0C2E]', text: 'text-[#7A0C2E]', btnSolid: 'bg-[#7A0C2E] hover:bg-violet-700 text-white', Icon: Monitor },
              ...
              { cardBg: 'bg-gradient-to-b from-[#e6f4ea] from-[40%] to-white to-[80%]', badge: 'bg-[#7A0C2E]', text: 'text-[#7A0C2E]', btnSolid: 'bg-[#7A0C2E] hover:bg-violet-700 text-white', Icon: Star }
            ];
