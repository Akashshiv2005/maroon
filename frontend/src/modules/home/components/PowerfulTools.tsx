  ...
  return (
    ...
    >
        ...
        <motion.div animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 3.5, ease: "easeInOut" }} className="relative w-full">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 p-5 overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <motion.div animate={{ opacity: [1, 0.4, 1] }} transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }} className="w-2 h-2 rounded-full bg-[#7A0C2E]" />
            ...
            <div className="grid grid-cols-3 gap-3 mb-5">
              {[
                { label:'Views', value:'84K', delta:'+32%', color:'text-[#7A0C2E]', bg:'bg-violet-50' },
                { label:'Leads', value:'3.2K', delta:'+58%', color:'text-[#7A0C2E]', bg:'bg-violet-50' },
                { label:'Calls', value:'1.8K', delta:'+24%', color:'text-[#7A0C2E]', bg:'bg-violet-50' },
              ].map((s,i)=>(
                <motion.div key={i} initial={{opacity:0,y:10}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:0.2+i*0.1}} className={`${s.bg} rounded-2xl p-3 text-center`}>
                  ...
                  <p className="text-[9px] text-[#7A0C2E] font-bold mt-0.5">{s.delta}</p>
                </motion.div>
              ))}
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-black text-[#7A0C2E]">2026</span>
              </div>
              <div className="relative flex items-end gap-1.5" style={{ height: 120 }}>
                ...
                {[
                  ...
                  { label:'F', px:62,  color:'from-violet-500 to-[#7A0C2E]', shadow:'shadow-violet-300/50' },
                  ...
                  { label:'M', px:66,  color:'from-violet-500 to-[#7A0C2E]', shadow:'shadow-violet-300/50' },
                  ...
                  { label:'A', px:106, color:'from-violet-500 to-[#7A0C2E]', shadow:'shadow-violet-300/50' },
                  { label:'S', px:88,  color:'from-purple-400 to-violet-500', shadow:'shadow-purple-300/50' },
                  { label:'O', px:114, color:'from-violet-500 to-[#7A0C2E]', shadow:'shadow-violet-400/50' },
                  { label:'N', px:96,  color:'from-violet-500 to-[#7A0C2E]', shadow:'shadow-violet-400/50' },
                  { label:'D', px:120, color:'from-[#7A0C2E] to-purple-700', shadow:'shadow-violet-500/60' },
                ].map((bar, i) => (
            ...
            <div className="flex items-center justify-between bg-violet-50/60 rounded-xl px-3 py-2 border border-violet-100">
              ...
              <svg viewBox="0 0 80 30" className="w-20 h-8">
                <polyline points="0,25 15,18 30,22 45,10 60,14 80,4" fill="none" stroke="#7A0C2E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <motion.circle animate={{ scale: [1, 2], opacity: [1, 0] }} transition={{ repeat: Infinity, duration: 1.5, ease: "easeOut" }} cx="80" cy="4" r="3" fill="#7A0C2E" style={{transformOrigin:'80px 4px'}}/>
                <circle cx="80" cy="4" r="2" fill="#7A0C2E"/>
              </svg>
              <span className="text-xs font-black text-rose-700">#2</span>
            </div>
          </div>
          ...
          <motion.div animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 3.5, ease: "easeInOut" }} className="absolute -top-5 -right-5 bg-white rounded-2xl shadow-xl border border-slate-100 px-3 py-2 flex items-center gap-2">
            <div className="w-7 h-7 bg-violet-100 rounded-full flex items-center justify-center relative">
              <Phone size={12} className="text-[#7A0C2E]"/>
          ...
          <motion.div animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 4.5, ease: "easeInOut" }} className="absolute -bottom-5 -left-5 bg-[#7A0C2E] rounded-2xl shadow-xl px-3 py-2 flex items-center gap-2">
      ...
      <div className="flex-[1.2] w-full relative z-10">
        <motion.div initial={{opacity:0,x:20}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{delay:0.1}} className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#7A0C2E] text-white rounded-full text-xs font-bold mb-5 shadow-lg shadow-[#7A0C2E]/25">
        ...
        <motion.h2 initial={{opacity:0,y:15}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:0.15}} className="text-3xl md:text-4xl font-black text-slate-900 mb-3 leading-tight">
          ...
          <span className="text-[#7A0C2E]">for Your Business</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:gap-4 mb-6 sm:mb-8">
          {[
            { icon:<Monitor size={16}/>, title:'Dashboard', sub:'Profile & leads', bg:'bg-violet-50', color:'text-[#7A0C2E]' },
            { icon:<BarChart size={16}/>, title:'Analytics', sub:'Customer insights', bg:'bg-violet-50', color:'text-[#7A0C2E]' },
            { icon:<TrendingUp size={16}/>, title:'Marketing', sub:'Promote business', bg:'bg-violet-50', color:'text-[#7A0C2E]' },
            { icon:<Headphones size={16}/>, title:'Support', sub:'24/7 Expert help', bg:'bg-violet-50', color:'text-[#7A0C2E]' },
          ].map((f,i)=>(
        ...
        <Link
          href="/register"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#7A0C2E] hover:bg-violet-700 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base shadow-xl shadow-[#7A0C2E]/25 transition-all active:scale-95"
        >
