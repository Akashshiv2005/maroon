  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12 relative z-10">
        <span className="inline-flex items-center gap-1.5 bg-violet-50 border border-violet-100 text-rose-700 px-3.5 py-1 rounded-full text-xs font-bold mb-4 tracking-wide uppercase shadow-2xs">
          <motion.div animate={{ opacity: [1, 0.4, 1] }} transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }}><MessageSquare size={12} className="text-[#7A0C2E]" /></motion.div>
          Platform Reviews
        </span>
        <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-3 tracking-tight">
          What Our <span className="text-[#7A0C2E]">Users Say</span>
        </h2>
              ...
              <div className="flex items-center justify-between border-t border-slate-200/40 pt-5 mt-auto relative z-10">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <div className="w-11 h-11 rounded-full bg-[#7A0C2E] flex items-center justify-center text-white text-sm font-black shadow-inner border border-white/50">
