    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-xl">
            <h2 className="text-4xl lg:text-[44px] font-black leading-tight text-slate-900 mb-4">
              ...
              <span className="text-[#7A0C2E]">Businesses Near You</span>
            </h2>
            <p className="text-slate-500 text-lg font-medium">Handpicked services and top-rated businesses trusted by people like you.</p>
          </div>
          <Link href="/search" className="inline-flex items-center gap-3 border border-slate-200 px-6 py-3 rounded-full font-bold text-slate-700 hover:border-violet-300 hover:bg-rose-50/50 transition-all shrink-0">
            View All Categories <div className="w-6 h-6 bg-[#7A0C2E] text-white rounded-full flex items-center justify-center"><ArrowRight size={14}/></div>
          </Link>
        </div>
        ...
        <div className="relative h-[480px] flex items-center justify-center max-w-5xl mx-auto">
          ...
          <button className="absolute left-0 z-20 w-12 h-12 bg-white rounded-full border border-slate-100 shadow-xl flex items-center justify-center text-slate-600 hover:text-[#7A0C2E] hover:scale-110 transition-all">
            <ChevronLeft size={24} />
          </button>

          <button className="absolute right-0 z-20 w-12 h-12 bg-white rounded-full border border-slate-100 shadow-xl flex items-center justify-center text-slate-600 hover:text-[#7A0C2E] hover:scale-110 transition-all">
              ...
              return (
                ...
                >
                  <div className="h-[65%] relative w-full overflow-hidden rounded-b-[2rem]">
                    ...
                    <div className={`absolute -bottom-6 left-6 w-14 h-14 rounded-2xl bg-[#7A0C2E] text-white flex items-center justify-center shadow-lg shadow-[#7A0C2E]/40 z-10 ${isActive ? 'scale-100' : 'scale-0'} transition-transform delay-300`}>
                  ...
                  <div className="pt-10 px-6 pb-6 bg-white h-[35%] flex flex-col justify-center">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-[#7A0C2E] font-bold text-xs">{cat.count} Listings</p>
                      {isActive && <ArrowRight size={18} className="text-[#7A0C2E]" />}
                    </div>
                  </div>
                </div>
              );
