...
export default function HeroSection() {
  return (
    <div className="relative bg-transparent overflow-hidden pt-6 pb-12 lg:pt-8 lg:pb-16 border-b border-emerald-100/50">
      {/* Bright ambient blobs optimized for performance (removed animate-pulse and mix-blend to prevent scroll jank) */}
      <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-emerald-300/20 rounded-full filter blur-[100px] opacity-60 pointer-events-none transform-gpu" />
      <div className="absolute top-12 -left-24 w-[500px] h-[500px] bg-green-200/30 rounded-full filter blur-[100px] opacity-60 pointer-events-none transform-gpu" />
      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 relative z-20">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 mb-10">
          ...
          <div className="flex-1 w-full text-center lg:text-left">
            ...
            >
              <div className="w-5 h-5 rounded-full bg-[#7A0C2E] flex items-center justify-center text-white shrink-0">
            ...
            >
              Discover More.<br />
              Choose{" "}
              <span className="relative inline-block text-[#7A0C2E] drop-shadow-[0_0_15px_rgba(67,27,148,0.4)]">
            ...
            >
              Everything you need, all in one place with <span className="text-[#7A0C2E] font-extrabold">BizDial.</span>
            </motion.p>
            ...
            >
              {[
                ...
                >
                  <div className="w-5 h-5 rounded-full bg-[#7A0C2E] text-white flex items-center justify-center shrink-0">
          ...
          >
            <div className="relative w-full max-w-[850px] scale-105 lg:scale-[1.15] lg:translate-x-12 lg:-translate-y-4 origin-right transform-gpu">
              ...
              <div className="absolute inset-y-0 left-0 w-[15%] bg-gradient-to-r from-[#FFF5F2] to-transparent pointer-events-none z-10" />

              <Image 
                src="/hero-section-warm.png" 
        ...
        >
          ...
          {[
            ...
            <a 
              ...
              className="px-4 py-1.5 bg-white rounded-full font-semibold text-slate-700 hover:text-[#7A0C2E] border border-slate-200/90 transition-all shadow-2xs"
            >
              {tag}
            </a>
          ))}
        ...
        >
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 divide-y sm:divide-y-0 sm:divide-x divide-[#7A0C2E]/15">
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="flex items-center gap-4 pt-3 sm:pt-0 sm:pl-4 first:pl-0 first:pt-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-orange-50 text-[#F95F19] flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="flex items-center gap-4 pt-3 sm:pt-0 sm:pl-4 first:pl-0 first:pt-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-green-50 text-[#10B981] flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="flex items-center gap-4 pt-3 sm:pt-0 sm:pl-4 first:pl-0 first:pt-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-rose-50/70 text-[#EE5D50] flex items-center justify-center shrink-0 shadow-2xs">
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="flex items-center gap-4 pt-3 sm:pt-0 sm:pl-4 first:pl-0 first:pt-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-purple-50 text-[#8C4BEB] flex items-center justify-center shrink-0 shadow-2xs">
          ...
          {[
            {
              ...
              link: "/search",
              iconBg: "bg-orange-50",
              iconColor: "text-[#F95F19]",
              hoverBg: "group-hover:bg-[#F95F19]"
            },
            {
              title: "Compare",
            ...
            },
            {
              ...
              link: "/register",
              iconBg: "bg-purple-50",
              iconColor: "text-[#8C4BEB]",
              hoverBg: "group-hover:bg-[#8C4BEB]"
            }
          ].map((card, idx) => (
            <motion.a 
              key={idx}
              ...
              href={card.link}
              className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-100 shadow-2xs hover:shadow-md hover:border-[#7A0C2E]/40 group flex items-center justify-between gap-3"
            >
              <div className="flex items-center gap-3.5">
                <div className={`w-12 h-12 rounded-full ${card.iconBg} ${card.iconColor} flex items-center justify-center shrink-0 ${card.hoverBg} group-hover:text-white transition-colors duration-300`}>
              ...
              <div className={`w-9 h-9 rounded-full ${card.iconBg} ${card.iconColor} flex items-center justify-center shrink-0 ${card.hoverBg} group-hover:text-white transition-all duration-300`}>
