      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 xl:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 mb-10 sm:mb-14">
          ...
          <div className="md:col-span-6 space-y-4">
            ...
            <div className="w-10 h-1 bg-[#7A0C2E] rounded-full"></div>
          ...
          <div className="md:col-span-6 grid grid-cols-2 gap-6 sm:gap-10">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-7 h-7 rounded-lg bg-violet-50 text-[#7A0C2E] flex items-center justify-center shrink-0">
              ...
              <ul className="space-y-2.5 text-xs text-slate-600 font-semibold">
                {[
                  ...
                  <li key={idx}>
                    ...
                    }} className="hover:text-[#7A0C2E] transition-colors text-left py-0.5 block">
                      {item.name}
                    </button>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-xs text-slate-600 font-semibold">
                {[
                  ...
                  <li key={idx}>
                    {item.isRoute ? (
                      <Link href={item.href} className="hover:text-[#7A0C2E] transition-colors text-left py-0.5 block">
                        {item.name}
                      </Link>
                    ) : (
                      <button onClick={() => {
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-6 mb-8 shadow-xs border border-slate-200/80 grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-violet-50 text-[#7A0C2E] flex items-center justify-center shrink-0">
