    ...
    <div ref={wrapperRef} className="relative z-50">
      ...
      >
        ...
        <div className="flex-[1.2] flex items-center gap-3 px-4 py-2 border-b md:border-b-0 md:border-r border-slate-200 w-full hover:bg-slate-50/50 transition-colors rounded-t-xl md:rounded-2xl relative">
          <Search size={22} className="text-[#7A0C2E] shrink-0" />
        ...
        <div className="flex-1 flex items-center gap-3 px-4 py-2 w-full hover:bg-slate-50/50 transition-colors rounded-b-xl md:rounded-2xl">
          <MapPin size={22} className="text-[#7A0C2E] shrink-0" />
          <div className="flex flex-col w-full text-left">
        ...
        <div className="w-full md:w-auto flex flex-row items-center gap-3 shrink-0 px-2 pb-2 md:p-0 mt-2 md:mt-0">
          <button 
            ...
            className="flex-1 sm:flex-none whitespace-nowrap px-5 py-3.5 bg-rose-100/70 hover:bg-rose-200/80 text-[#7A0C2E] rounded-2xl font-bold transition-all flex items-center justify-center gap-2 text-sm shadow-xs"
          >
          ...
          <button 
            ...
            className="flex-[2] sm:flex-none whitespace-nowrap px-8 py-3.5 bg-[#7A0C2E] hover:bg-[#5C0520] text-white rounded-2xl font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#7A0C2E]/25 text-sm"
          >
