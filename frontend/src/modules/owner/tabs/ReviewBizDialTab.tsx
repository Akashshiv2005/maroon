...
export default function ReviewBizDialTab({ businessId, profile }: Props) {
  ...
  const statusConfig = {
    ...
    approved: { label: 'Live on Homepage', icon: CheckCircle, color: 'emerald', bg: 'bg-emerald-50', text: 'text-rose-700', border: 'border-emerald-200' },
        ...
        {submitted && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-[#7A0C2E]">Your review is under admin review. Once approved, it'll appear on our homepage.</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
              ...
              return (
                ...
                >
                  ...
                  {review.status === 'approved' && (
                    <p className="text-xs text-[#7A0C2E] bg-emerald-50 rounded-xl px-3 py-2 mt-3 font-medium">
