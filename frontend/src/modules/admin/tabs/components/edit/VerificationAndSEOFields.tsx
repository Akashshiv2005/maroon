      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              className="w-full px-4 py-2.5 rounded-2xl border border-slate-200 font-bold text-slate-800 bg-slate-50/50 outline-none focus:ring-4 focus:ring-rose-500/15 shadow-inner transition-all hover:border-emerald-300"
