                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <span className={`px-3 py-1 text-[10px] uppercase tracking-wider font-black rounded-full ${
                        ...
                        'bg-emerald-100 text-rose-700 border border-emerald-200'
                      }`}>
                        {kw.priority}
                      </span>
                    </td>
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-1.5 text-xs font-bold text-[#7A0C2E] bg-emerald-50/50 px-3 py-1.5 rounded-lg w-fit border border-emerald-100">
