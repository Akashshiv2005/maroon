    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
          ...
          <div className="text-xs text-[#7A0C2E] font-bold mt-2 flex items-center gap-1">
                  ...
                  <tr key={i} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <span className={`px-2.5 py-1 text-[10px] uppercase tracking-wider font-extrabold rounded-full ${
                        ...
                        'bg-emerald-100 text-rose-700'
                      }`}>
                        {kw.priority}
                      </span>
                    </td>
                    <td className="py-4 px-6">
                      <span className="inline-flex items-center gap-1 text-xs font-bold text-[#7A0C2E] bg-emerald-50 px-2.5 py-1 rounded-md">
